...
function update_search_results_async(query, live)
    get_subs_to_search_in_async(function(subs)
        ...
        result_list.header = "Search results for \"" .. query .. "\" [* shows all subs]\\N"
        result_list.header = result_list.header .. "for exact ' word' match put space before and/or after\\N"
        result_list.header = result_list.header .."'v' to hide/show subtitles, Ctrl+f AutoScroll"
