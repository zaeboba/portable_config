...
--END OF SAMPLE REPLACE ]=====]
  ...
  --Use ~ for home directory. Leave as empty to use dir near mpv's executable
  playlist_savepath = "",
  
  --Leave as empty to save into the same folder where the files are located
  playlist_local_savepath = "",
  
  --Playlist name prefix, useful to pin playlist files in folder with default alphabetical sorting
